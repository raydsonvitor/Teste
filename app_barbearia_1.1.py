...
def DeleteTreeviewItem():
    try:
        ...
        print(f'linha de código {valores[0]} deletado na treeview')
        print('Erro na função DeleteTreeviewItem, arquivo app.py')


#  FRAME 0 \\ Upper Label

frame_0 = CTkFrame(janela_main, width=1366, height=50, fg_color='blue')
...
frame_0_widget_3 = CTkButton(frame_0, width=10, height=10 ,image=imagem_excluir, text='', hover=True, fg_color='white', command=lambda:DeleteTreeviewItem())
...
# FRAME 7 \\ EXPOSITOR DO FATURAMENTOS DO DIA POR TIPO
    ...
    frame_7 = CTkFrame(janela_main, width=775, height=100, border_width=1, border_color='white')
    frame_7.place(relx=0.175, rely=0.8)
    
    #widget's

    frame_7_Widget_0 = CTkLabel(frame_7, width=90 , text=' DINHEIRO ', font=fonte_c, fg_color='blue')
    frame_7_Widget_0.place(x=20, y=10)
    frame_7_Widget_1 = CTkLabel(frame_7, width=118 ,textvariable=frame_7_Widget_1_textvar, font=fonte_c, fg_color='black')
    frame_7_Widget_1.place(x=155, y=10)

    frame_7_Widget_2 = CTkLabel(frame_7, width=90 , text=' CARTÃO ', font=fonte_c, fg_color='blue')
    frame_7_Widget_2.place(x=285, y=10)
    frame_7_Widget_3 = CTkLabel(frame_7, width=118 ,textvariable=frame_7_Widget_3_textvar, font=fonte_c, fg_color='black')
    frame_7_Widget_3.place(x=405, y=10)

    frame_7_Widget_4 = CTkLabel(frame_7, width=90 , text=' PIX ', font=fonte_c, fg_color='blue')
    frame_7_Widget_4.place(x=535, y=10)
    frame_7_Widget_5 = CTkLabel(frame_7, width=118 ,textvariable=frame_7_Widget_5_textvar, font=fonte_c, fg_color='black')
    frame_7_Widget_5.place(x=625, y=10)
    ...
    frame_7_Widget_8 = CTkLabel(frame_7, width=118 ,textvariable=frame_7_Widget_8_textvar, font=fonte_c, fg_color='black', text_color='green')
...
# FRAME 8 \\ EXPOSITOR DE PERIODO
    ...
    frame_8 = CTkFrame(janela_main,  width=160, height=33 ,border_width=1, border_color='white')
    frame_8.place(x=35, y=650)

    #widgets

    frame_8_Widget_0 = CTkLabel(frame_8, width=80, text='Período', font=fonte_b, fg_color='blue')
    frame_8_Widget_0.place(x=2, y=1)
    frame_8_Widget_1 = CTkLabel(frame_8, width=79 ,textvariable=frame_8_widget_0_textvar, font=fonte_b, fg_color='black')
    frame_8_Widget_1.place(x=80, y=1) 
